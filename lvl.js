export class lvl extends Phaser.Scene {
    ...
    update() {
        ...
        const magatamaCount = this.magatama;
        this.doubleJumpCount = magatamaCount;
        console.log(this.magatamaCount);
        console.log(this.doubleJumpCount);
